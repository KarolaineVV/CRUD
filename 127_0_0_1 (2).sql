...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 09-07-2022 a las 18:56:45
...
(123, '', '', '', '', '', '', 1),
(145, '', '', '', '', '', '', 2),
(146, 'CC', '1001882539', 'keyla johana', 'villero villazon', 'mz 64 casa 21 apt 1 450 años 2 etapa', '3126807288', 2),
(148, 'CC', '1002345675', 'kevin', 'villero', 'calle 30', '3013033847', 1);
...
--
ALTER TABLE `aprendices`
  MODIFY `id_apre` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=149;

--
-- AUTO_INCREMENT de la tabla `fichas`
--
ALTER TABLE `fichas`
  MODIFY `id_ficha` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=24345679;

--
-- AUTO_INCREMENT de la tabla `programa`
--
ALTER TABLE `programa`
  MODIFY `id_prog` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=13;
